...
// select 3 things 1.form 2.amount 3.input

const form =document.querySelector('.lorem-form');
const amount = document.getElementById('amount');
const result = document.querySelector('.lorem-text');

//這次我們addeventlistener不用click 而是用 submit
form.addEventListener('submit',function(e){
    // console.log("hello");
    //form的default是submit給server 所以一旦我們click button  上面的log很快就會消失 所以要用preventDefault才能看到
    e.preventDefault();
    const value = parseInt(amount.value); //但value的type是string 用parseInt轉成number
